...
if "intro" not in st.session_state:
    #read-in summary json
    with open('summary.json', 'r') as f:
        summary = json.load(f)
    st.session_state.intro = summary
...
def display_citations(citations: dict, with_expander=True):
    """
...
def main():
    st.title("History of Orthodontics〽️")

    st.write("All content is generated by a Molus AI that extracts information from this YouTube [playlist](https://www.youtube.com/watch?v=EzDMgBH5fIo&list=PLrHZXv7CXXhAsw4-MKjkgx2GYlsrPPyVT&index=1).")

    with st.expander("Course Details 📚"):   
        st.write("**Summary**\n\n" + st.session_state.intro['summary'])
        st.write(st.session_state.intro['themes'])
        display_citations(st.session_state.intro['citations'], with_expander=False)
